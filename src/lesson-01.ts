export default class calculator {
     ...
     */
    users: Array<{ name: string, email: string }> = [{ name: "John Doe", email: "johndoe@gmail.com" }, { name: "Jane Doe", email: "janedoe@gmail.com" }]
    ...
    products: Array<{ name: string, price: number, stock: number, active?: boolean }> =
        [{ name: "computer", price: 500000, stock: 10, active: true }, { name: "camera", price: 150000, stock: 8 }]

    /** 
     * Inicializálj egy tuple típust, azaz adj neki értéket is.
     * @type {Tuple} role - number, string, boolean. 
     */
    role: [number, string, boolean] = [32, "yes", true]
